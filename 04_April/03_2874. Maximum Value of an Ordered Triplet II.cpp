...
// Approach 1 (Brute Force TlE: 581 / 599 testcases passed): Use brute force with three nested loops to evaluate all ordered triplets (i, j, k) where i < j < k and compute (nums[i] - nums[j]) * nums[k] to find the maximum triplet value.
